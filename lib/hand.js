...
class HandObj{
  ...
  validPlay(currentPlay){
    ...
    switch (currentPlay.type) {
      ...
      case "sequence":
        if (!Object.keys(this.cardsByCount).every(val => this.cardsByCount[val].cards.length === 1)) {
          return "pass";
        }
      ...
      case "quad":
        if (currentPlay.start === true) {
          if (Object.keys(this.cardsByCount).length != 1 || this.cardsByCount[3] && (this.cardsByCount[3].cards.length !== 4)) {
            return "pass";
      ...
      case "trio":
        if (currentPlay.start === true) {
          if (Object.keys(this.cardsByCount).length != 1 || this.cardsByCount[3] && (this.cardsByCount[3].cards.length !== 3)) {
            return "pass";
      ...
      case "pair":
        if (currentPlay.start === true) {
          if (Object.keys(this.cardsByCount).length != 1 || this.cardsByCount[3] && (this.cardsByCount[3].cards.length !== 2)) {
            return "pass";
